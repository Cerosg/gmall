...
public class AttrController {
    ...
    @GetMapping("/category/{cid}")//category/{cid}?type=0&searchType=1
    ...
    public ResponseVo<List<AttrEntity>> queryAttrsByGid(
        ...
        return ResponseVo.ok(attrService.queryAttrsByGid(cid, type, searchType));
    }

    @GetMapping("/group/{gid}")
    @ApiOperation("根据分组id查询分组中的属性")
